...
bool  DFA::next(char  input,  Token&  buf)  {
    if(cur_state==State::Empty){
        ...
        else if((input>='0' && input<='9')|| input=='b' || input=='x'|| input=='h'|| input=='d'){
            cur_state = State::IntLiteral;
            cur_str = "";
            cur_str.push_back(input);
        }
        else cur_state = State::Empty;
        return false;
    }
        ...
        else if((input>='0' && input<='9')|| input=='b' || input=='x'|| input=='h'|| input=='d' || (input>='A' && input <='F')){
            cur_state = State::IntLiteral;
            cur_str.push_back(input);
        }
        else{
